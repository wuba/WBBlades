...
- (void)handleMouseDown:(NSEvent*)theEvent inCell:(PXListViewCell*)theCell // Central funnel for cell clicks so cells don't have to know about multi-selection, modifiers etc.
{
    ...
    BOOL		shouldToggle = theEvent == nil || ([theEvent modifierFlags] & NSEventModifierFlagCommand) || ([theEvent modifierFlags] & NSEventModifierFlagShift);	// +++ Shift should really be a continuous selection.
