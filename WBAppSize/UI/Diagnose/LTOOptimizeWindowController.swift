//
//  LTOOptimizeWindowController.swift
//  AppSizeManager
//
...
class LTOOptimizeWindowController: NSWindowController {
    ...
    lazy var myWindow: NSWindow? = {
        ...
        window.title = ASTextDictionary.valueForKey(key: "LTOWindowTitle")
    ...
    lazy var viewController: LTOOptimizeViewController = {
        let viewController = LTOOptimizeViewController()
