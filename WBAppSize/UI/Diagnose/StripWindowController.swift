...
class StripWindowController: NSWindowController {
    ...
    lazy var myWindow: NSWindow? = {
        ...
        window.title = ASTextDictionary.valueForKey(key: "stripWindowTitle")
    ...
    lazy var viewController: StripViewController = {
        let viewController = StripViewController()
